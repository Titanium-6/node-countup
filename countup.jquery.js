        ...
        window.requestAnimationFrame ||
            ...
            (l.initialize = function () {
                return (
                    ...
                    l.d ? ((l.startVal = Number(n)), (l.endVal = Number(t)), s(l.startVal) && s(l.endVal) ? ((l.decimals = Math.max(0, e || 0)), (l.dec = Math.pow(10, l.decimals)), (l.duration = 1e3 * Number(i) || 2e3), (l.countDown = l.startVal > l.endVal), (l.frameVal = l.startVal), (l.initialized = !0), !0) : ((l.error = "[CountUp] startVal (" + n + ") or endVal (" + t + ") is not a number"), !1)) : ((l.error = "[CountUp] target is null or undefined"), !1))
                );
            }),
